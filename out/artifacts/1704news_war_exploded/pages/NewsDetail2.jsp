                ...
                <div class="main-text-box-bbg">
                    <div class="article-box">
                        ...
                        <div class="article-content">
                            <span class="article-summary"><b>摘要：</b><%out.print("吴亦凡在绿洲晒出头戴松鼠毛毯的可爱自拍，俏皮地问大家：“小朋友，今天这样可以过节吗？");%></span>
                            <p><%out.print(" 6月1日，吴亦凡[微博]在绿洲晒出头戴松鼠毛毯、史迪仔帽子的可爱自拍，<br/>俏皮地问大家：“小朋友，今天这样可以过节吗？”<br/>网友纷纷回复：“可以可以 小朋友说啥都对！” <br/>期待你今晚幼儿园文艺汇演，每个妈会准时到场。”<br/>" );%>
<%--                                <img src="<%=request.getContextPath() %>/images/news-1.jpg" />--%>
                            </P>
                        </div>
                        <div class="comment">
                            <dl>
